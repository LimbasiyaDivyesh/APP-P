                ...
                `,children:[e.jsx("div",{className:`
                    ...
                    `,children:[e.jsx("div",{className:"flex items-center justify-between",children:e.jsx("div",{className:`
                        ...
                        `,children:r.label})]})]},r.label)})})}),e.jsx("div",{className:"mb-4 flex justify-center",children:e.jsxs("div",{className:"relative w-full max-w-md",children:[e.jsx("input",{type:"text",placeholder:"Search by name...",value:S,onChange:r=>F(r.target.value),className:`\r
                                ...
                                text-sm\r
                            `}),e.jsx("i",{className:"fa-solid fa-magnifying-glass absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"})]})}),v&&v.length>0?e.jsxs(e.Fragment,{children:[e.jsx(Qe,{timePreference:N==null?void 0:N.toLowerCase(),entries:[...Z].sort((r,c)=>{var l,C;return((l=r.registerIndex)!=null?l:-1/0)-((C=c.registerIndex)!=null?C:-1/0)}),handleUpdateCustomerMilkEntry:J,fetchRegister:H,estimate:y.estimate,showDragColumn:y.showDragColumn},"daily-register"),T.length>0&&e.jsx("div",{className:"flex justify-center mb-6",children:e.jsxs("label",{className:`\r
...
\r
        ...
        `}),e.jsx(f.Switch,{id:"autoMilkEntry",name:"autoMilkEntry",checked:b,onChange:()=>U(!b),className:`\r
                peer scale-110\r
