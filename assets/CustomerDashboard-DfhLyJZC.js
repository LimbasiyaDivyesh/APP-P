var T=Object.defineProperty,S=Object.defineProperties;var k=Object.getOwnPropertyDescriptors;var N=Object.getOwnPropertySymbols;var O=Object.prototype.hasOwnProperty,B=Object.prototype.propertyIsEnumerable;var j=(o,r,t)=>r in o?T(o,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[r]=t,_=(o,r)=>{for(var t in r||(r={}))O.call(r,t)&&j(o,t,r[t]);if(N)for(var t of N(r))B.call(r,t)&&j(o,t,r[t]);return o},D=(o,r)=>S(o,k(r));var b=(o,r,t)=>new Promise((c,x)=>{var h=i=>{try{e(t.next(i))}catch(l){x(l)}},m=i=>{try{e(t.throw(i))}catch(l){x(l)}},e=i=>i.done?c(i.value):Promise.resolve(i.value).then(h,m);e((t=t.apply(o,r)).next())});import{j as s}from"./pdfVendor-DdAo4azW.js";import{f as L,a as d}from"./reactVendor-BrBFq9LG.js";import{u as H,a as I,L as M,A as q}from"./index-CqydgjTW.js";import{F}from"./index-BWHmAC32.js";import R from"./PaymentHistory-R-D6QfMx.js";import{D as $}from"./DashboardHeader-OAH8550N.js";import"./reduxVendor-C8DwjTzm.js";import"./uiVendor-jE8dGr1d.js";import"./useApiLoading-BdX-7ebN.js";import"./ClockIcon-CCcvREjO.js";import"./PlatformClassProvider-CKWjML-4.js";function ee(){var y,v,w;const o=L(),{t:r}=H(),{appSelector:t,dispatch:c}=I(),[x,h]=d.useState(!1),{loginData:m,selectedAdmin:e}=t(a=>a.app),i=(m==null?void 0:m.admins)||[],l=d.useCallback(a=>{c({type:"APP_SET_SELECTED_ADMIN",payload:a,name:"selectedAdmin",meta:{type:"SET_SELECTED_ADMIN"}})},[c]),g=d.useCallback(()=>{h(!0)},[]);d.useEffect(()=>{!e&&i.length>0&&l(i[0])},[i,e,l]),d.useEffect(()=>{M.requestPermissions(),P()},[]),d.useEffect(()=>{b(null,null,function*(){yield c(yield q({apiUrl:"auth/customer/session",loader:!1,apiSuccessCallBack:a=>{const{user:n}=a,p=D(_({},m),{role:n.role,user:n,admins:n.admins||[]});if(c({type:"APP_SET_LOGIN_DATA",payload:p,name:"loginData",meta:{type:"SET_LOGIN_DATA"}}),e!=null&&e._id){const u=((n==null?void 0:n.admins)||[]).find(E=>E._id===e._id);u&&l(u)}}}))})},[]);const f=()=>{var a;(a=e==null?void 0:e.customer)!=null&&a._id&&o(`/customerBill/${e.customer._id}`)},P=()=>b(null,null,function*(){try{return(yield F.requestPermissions()).publicStorage==="granted"?!0:(yield Permissions.request({name:"photos"})).state==="granted"}catch(a){return console.error("Permission error:",(a==null?void 0:a.message)||a),!1}}),C=d.useMemo(()=>{var n;const a=[{icon:"fa-file-invoice",label:r("dashboard.customerDashboard.viewBillTitle"),onClick:f},{icon:"fa-indian-rupee-sign",label:r("dashboard.customerDashboard.paymentsTitle"),onClick:g}];return(n=e==null?void 0:e.settings)!=null&&n.allowOtherSaleOrder&&a.push({icon:"fa-basket-shopping",label:r("dashboard.customerDashboard.myOrdersTitle"),onClick:()=>o("/myOrders")}),a},[r,e,o]);return s.jsxs(s.Fragment,{children:[s.jsx($,{roleLabel:r("dashboard.header.roleCustomer"),identityName:((y=e==null?void 0:e.customer)==null?void 0:y.name)||r("dashboard.header.roleCustomer"),identityRole:r("dashboard.header.roleCustomer"),menuItems:C}),s.jsxs("div",{className:"relative px-0 py-4 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 h-safe overflow-y-auto",children:[(i==null?void 0:i.length)>1&&s.jsx("div",{className:"px-3 sm:px-4",children:s.jsx("div",{className:`\r
        flex sm:grid\r
        sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4\r
        gap-4 sm:gap-6\r
        overflow-x-auto sm:overflow-visible\r
        no-scrollbar py-2\r
    `,children:i.map((a,n)=>{var u;const p=(e==null?void 0:e._id)===a._id;return s.jsx("div",{className:"min-w-[160px] sm:min-w-0",children:s.jsx("div",{onClick:()=>l(a),className:`
                        ...
                        `,children:s.jsx("div",{className:`
                            ...
                            `,children:s.jsxs("div",{className:"space-y-1 w-full",children:[s.jsx("h3",{className:"text-xs sm:text-sm font-extrabold text-gray-900 truncate",children:a.name}),s.jsx("p",{className:"text-[10px] sm:text-xs text-gray-900 truncate",children:((u=a.company)==null?void 0:u.companyName)||r("dashboard.customerDashboard.noCompany")}),s.jsx("p",{className:"text-xs text-gray-900 truncate",children:a.phone||r("dashboard.customerDashboard.noPhone")})]})})})},a._id)})})}),e&&s.jsx("div",{className:"relative z-10 px-3 sm:px-4 mt-4",children:s.jsxs("div",{className:`\r
        grid\r
        grid-cols-1\r
        sm:grid-cols-2\r
        md:grid-cols-3\r
