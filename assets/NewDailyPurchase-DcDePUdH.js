...
\r
        ...
        `}),e.jsx(b.Switch,{id:"autoMilkEntry",name:"autoMilkEntry",checked:v,onChange:()=>d(!v),className:`\r
                peer scale-110\r
        ...
        `,children:E.map(({animalName:s,totalLiter:x,pricePerUnit:t})=>e.jsxs("div",{className:`\r
                    ...
                    `}),e.jsxs("div",{className:"relative p-5",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("div",{className:`\r
                                ...
                                text-gray-900\r
                                font-semibold\r
                            `,children:s}),!v&&e.jsxs("div",{className:"text-[12px] text-indigo-600 font-bold mt-1",children:["₹ ",t," / Liter"]})]}),e.jsx("div",{className:"mt-2 flex items-end justify-between",children:e.jsxs("div",{className:"flex items-end gap-1",children:[e.jsx("span",{className:`\r
                                    text-[25px]\r
                                    font-extrabold\r
                                    text-gray-900\r
                                    leading-none\r
