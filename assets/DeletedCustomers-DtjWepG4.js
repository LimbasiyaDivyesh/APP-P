var p=(s,m,o)=>new Promise((i,x)=>{var u=a=>{try{r(o.next(a))}catch(d){x(d)}},f=a=>{try{r(o.throw(a))}catch(d){x(d)}},r=a=>a.done?i(a.value):Promise.resolve(a.value).then(u,f);r((o=o.apply(s,m)).next())});import{u as R,r as n,d as _,A as y,j as e,b as c,R as A}from"./index-rAa2RaTK.js";import P from"./DefaultDashboardNavbar-CIVTzY2W.js";import{F as $}from"./UserIcon-D7lPgetU.js";const z=12,H=()=>{const{dispatch:s,appSelector:m}=R(),o=m(t=>t.app),{customerList:i={}}=o,{deletedCustomers:x=[]}=i,[u,f]=n.useState(""),[r,a]=n.useState(""),[d,O]=n.useState(1),[l,g]=n.useState({open:!1,type:null,customer:null}),T=_(),b=n.useCallback(()=>p(null,null,function*(){s(yield y({method:"POST",apiUrl:"customer/getListOfDeleteCustomers",storeActionType:"FETCH_ALL_DELETED_CUSTOMER_LIST",storeKey:"customerList"}))}),[s]),j=n.useMemo(()=>{let t=x;return r&&(t=t.filter(h=>{var w,v,C,S;return((w=h.name)==null?void 0:w.toLowerCase().includes(r))||((v=h.phone)==null?void 0:v.toLowerCase().includes(r))||((C=h.address)==null?void 0:C.toLowerCase().includes(r))||((S=h.cardNumber)==null?void 0:S.toString().includes(r))})),t},[x,r]),N=n.useMemo(()=>j.slice(0,d*z),[j,d]),k=t=>p(null,null,function*(){s(yield y({method:"POST",apiUrl:`customer/restore/${t._id}`,loader:!0,apiSuccessCallBack:()=>{b()}}))}),D=t=>p(null,null,function*(){s(yield y({method:"DELETE",apiUrl:`customer/${t._id}`,loader:!0,apiSuccessCallBack:()=>{b()}}))}),E=t=>{g({open:!0,type:"restore",customer:t})},L=t=>{g({open:!0,type:"delete",customer:t})};return n.useEffect(()=>{const t=setTimeout(()=>{a(u.trim().toLowerCase())},300);return()=>clearTimeout(t)},[u]),n.useEffect(()=>{b()},[]),e.jsxs(e.Fragment,{children:[e.jsx(P,{back:!0,onBack:()=>T("/manage")}),e.jsxs("div",{className:"bg-[#f3f4f6] px-2 py-4",children:[e.jsx("div",{className:"mb-4 flex justify-center",children:e.jsxs("div",{className:"relative w-full max-w-md",children:[e.jsx("input",{type:"text",placeholder:"Search deleted customers...",value:u,onChange:t=>f(t.target.value),className:`\r
