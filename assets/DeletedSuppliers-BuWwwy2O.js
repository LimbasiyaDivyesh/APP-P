var m=(t,p,i)=>new Promise((c,x)=>{var u=a=>{try{r(i.next(a))}catch(d){x(d)}},h=a=>{try{r(i.throw(a))}catch(d){x(d)}},r=a=>a.done?c(a.value):Promise.resolve(a.value).then(u,h);r((i=i.apply(t,p)).next())});import{u as R,r as n,d as _,A as b,j as e,b as o,R as A}from"./index-B-SeA6SC.js";import P from"./DefaultDashboardNavbar-lZYY5faU.js";const $=12,O=()=>{const{dispatch:t,appSelector:p}=R(),i=p(s=>s.app),{supplierList:c={}}=i,{deletedSuppliers:x=[]}=c,[u,h]=n.useState(""),[r,a]=n.useState(""),[d,U]=n.useState(1),[l,g]=n.useState({open:!1,type:null,supplier:null}),k=_(),y=n.useCallback(()=>m(null,null,function*(){t(yield b({apiUrl:"supplier/getListOfDeleteSuppliers",storeActionType:"FETCH_ALL_DELETED_SUPPLIER_LIST",storeKey:"supplierList"}))}),[t]),j=n.useMemo(()=>{let s=x;return r&&(s=s.filter(f=>{var N,w,S,C;return((N=f.name)==null?void 0:N.toLowerCase().includes(r))||((w=f.phone)==null?void 0:w.toLowerCase().includes(r))||((S=f.address)==null?void 0:S.toLowerCase().includes(r))||((C=f.cardNumber)==null?void 0:C.toString().includes(r))})),s},[x,r]),v=n.useMemo(()=>j.slice(0,d*$),[j,d]),D=s=>m(null,null,function*(){t(yield b({method:"POST",apiUrl:`supplier/restore/${s._id}`,loader:!0,apiSuccessCallBack:()=>{y()}}))}),E=s=>m(null,null,function*(){t(yield b({method:"DELETE",apiUrl:`supplier/${s._id}`,loader:!0,apiSuccessCallBack:()=>{y()}}))}),T=s=>{g({open:!0,type:"restore",supplier:s})},L=s=>{g({open:!0,type:"delete",supplier:s})};return n.useEffect(()=>{const s=setTimeout(()=>{a(u.trim().toLowerCase())},300);return()=>clearTimeout(s)},[u]),n.useEffect(()=>{y()},[]),e.jsxs(e.Fragment,{children:[e.jsx(P,{back:!0,onBack:()=>k("/manage")}),e.jsxs("div",{className:"bg-[#f3f4f6] px-2 py-4 h-safe overflow-y-auto",children:[e.jsx("div",{className:"mb-4 flex justify-center",children:e.jsxs("div",{className:"relative w-full max-w-md",children:[e.jsx("input",{type:"text",placeholder:"Search deleted suppliers...",value:u,onChange:s=>h(s.target.value),className:`\r
