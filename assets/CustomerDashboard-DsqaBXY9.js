var T=Object.defineProperty,S=Object.defineProperties;var k=Object.getOwnPropertyDescriptors;var _=Object.getOwnPropertySymbols;var B=Object.prototype.hasOwnProperty,L=Object.prototype.propertyIsEnumerable;var P=(i,r,t)=>r in i?T(i,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[r]=t,b=(i,r)=>{for(var t in r||(r={}))B.call(r,t)&&P(i,t,r[t]);if(_)for(var t of _(r))L.call(r,t)&&P(i,t,r[t]);return i},g=(i,r)=>S(i,k(r));var f=(i,r,t)=>new Promise((c,m)=>{var p=o=>{try{s(t.next(o))}catch(l){m(l)}},n=o=>{try{s(t.throw(o))}catch(l){m(l)}},s=o=>o.done?c(o.value):Promise.resolve(o.value).then(p,n);s((t=t.apply(i,r)).next())});import{j as e}from"./pdfVendor-DdAo4azW.js";import{f as H,a as d}from"./reactVendor-BrBFq9LG.js";import{u as I,a as M,L as O,A as q}from"./index-B81976vM.js";import{F}from"./index-DP-1ckcT.js";import R from"./PaymentHistory-DzglstS-.js";import{D as $}from"./DashboardHeader-DE5SulVc.js";import"./reduxVendor-C8DwjTzm.js";import"./uiVendor-EdgAqaye.js";import"./useApiLoading-6DapY8a3.js";import"./ClockIcon-CCcvREjO.js";import"./PlatformClassProvider-DxCGnQda.js";function ee(){var w,N,j;const i=H(),{t:r}=I(),{appSelector:t,dispatch:c}=M(),[m,p]=d.useState(!1),{loginData:n,selectedAdmin:s}=t(a=>a.app),o=(n==null?void 0:n.admins)||[],l=d.useCallback(a=>{c({type:"APP_SET_SELECTED_ADMIN",payload:a,name:"selectedAdmin",meta:{type:"SET_SELECTED_ADMIN"}})},[c]),y=d.useCallback(()=>{p(!0)},[]);d.useEffect(()=>{!s&&o.length>0&&l(o[0])},[o,s,l]),d.useEffect(()=>{O.requestPermissions(),D()},[]),d.useEffect(()=>{f(null,null,function*(){yield c(yield q({apiUrl:"auth/customer/session",loader:!1,apiSuccessCallBack:a=>{var u;const x=((u=a==null?void 0:a.user)==null?void 0:u.admins)||[];if(x.length&&(c({type:"APP_SET_LOGIN_DATA",payload:g(b({},n),{user:g(b({},n==null?void 0:n.user),{admins:x})}),name:"loginData",meta:{type:"SET_LOGIN_DATA"}}),s!=null&&s._id)){const h=x.find(E=>E._id===s._id);h&&l(h)}}}))})},[]);const v=()=>{var a;(a=s==null?void 0:s.customer)!=null&&a._id&&i(`/customerBill/${s.customer._id}`)},D=()=>f(null,null,function*(){try{return(yield F.requestPermissions()).publicStorage==="granted"?!0:(yield Permissions.request({name:"photos"})).state==="granted"}catch(a){return console.error("Permission error:",(a==null?void 0:a.message)||a),!1}}),C=d.useMemo(()=>[{icon:"fa-file-invoice",label:r("dashboard.customerDashboard.viewBillTitle"),onClick:v},{icon:"fa-indian-rupee-sign",label:r("dashboard.customerDashboard.paymentsTitle"),onClick:y}],[r,s]);return e.jsxs(e.Fragment,{children:[e.jsx($,{roleLabel:r("dashboard.header.roleCustomer"),identityName:((w=s==null?void 0:s.customer)==null?void 0:w.name)||r("dashboard.header.roleCustomer"),identityRole:r("dashboard.header.roleCustomer"),menuItems:C}),e.jsxs("div",{className:"relative px-0 py-4 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 h-safe overflow-y-auto",children:[(o==null?void 0:o.length)>1&&e.jsx("div",{className:"px-3 sm:px-4",children:e.jsx("div",{className:`\r
        flex sm:grid\r
        sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4\r
        gap-4 sm:gap-6\r
        overflow-x-auto sm:overflow-visible\r
        no-scrollbar py-2\r
    `,children:o.map((a,x)=>{var h;const u=(s==null?void 0:s._id)===a._id;return e.jsx("div",{className:"min-w-[160px] sm:min-w-0",children:e.jsx("div",{onClick:()=>l(a),className:`
                            relative cursor-pointer rounded-lg p-[1px] transition-all duration-500
                            ${u?"bg-gradient-to-br from-blue-500 via-indigo-900 to-purple-500":"bg-transparent"}
                        `,children:e.jsx("div",{className:`
                                rounded-xl h-full backdrop-blur-xl border transition-all duration-500
                                flex flex-col items-center text-center
                                p-4 sm:p-6 gap-3 sm:gap-4
                                ${u?"bg-white/95 border-white/40":"bg-white/80 border-gray-200 hover:bg-white hover:shadow-xl"}
                            `,children:e.jsxs("div",{className:"space-y-1 w-full",children:[e.jsx("h3",{className:"text-xs sm:text-sm font-extrabold text-gray-900 truncate",children:a.name}),e.jsx("p",{className:"text-[10px] sm:text-xs text-gray-900 truncate",children:((h=a.company)==null?void 0:h.companyName)||r("dashboard.customerDashboard.noCompany")}),e.jsx("p",{className:"text-xs text-gray-900 truncate",children:a.phone||r("dashboard.customerDashboard.noPhone")})]})})})},a._id)})})}),s&&e.jsx("div",{className:"relative z-10 px-3 sm:px-4 mt-4",children:e.jsxs("div",{className:`\r
        grid\r
        grid-cols-1\r
        sm:grid-cols-2\r
        md:grid-cols-3\r
