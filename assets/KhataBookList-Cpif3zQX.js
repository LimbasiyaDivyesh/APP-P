var N=(o,m,t)=>new Promise((r,p)=>{var n=l=>{try{c(t.next(l))}catch(i){p(i)}},d=l=>{try{c(t.throw(l))}catch(i){p(i)}},c=l=>l.done?r(l.value):Promise.resolve(l.value).then(n,d);c((t=t.apply(o,m)).next())});import{j as e,m as S}from"./uiVendor-Dy6p_79k.js";import{f as $,a as y}from"./reactVendor-BrBFq9LG.js";import{F as E,a as I}from"./formik.esm-Cybfx873.js";import{c as P,a as F}from"./index.esm-CtD9PYQy.js";import{a as T,u as C,A as w,r as a}from"./index-B6EveHNx.js";import{D as M}from"./DefaultDashboardNavbar-BQQO3QIk.js";import{F as R}from"./FloatingActionButton-hCw0fn4i.js";import{F as B}from"./FormInput-CW-t9V-G.js";import{F as O}from"./EllipsisVerticalIcon-D7GsYx2z.js";import{F as z,a as A}from"./TrashIcon-DWJrSFeB.js";import"./pdfVendor-BATutYTh.js";import"./reduxVendor-C8DwjTzm.js";import"./PlatformClassProvider-xCdxLhq8.js";const v=(o=0)=>new Intl.NumberFormat("en-IN").format(o),H=({open:o,onClose:m,book:t,onSaved:r})=>{const{dispatch:p}=T(),{t:n}=C(),d=!!(t!=null&&t._id),c=P().shape({name:F().trim().required(n("khata.bookForm.validation.nameRequired")),description:F()}),l=i=>N(null,null,function*(){yield p(yield w({method:d?"PUT":"POST",apiUrl:d?`khataBook/${t._id}`:"khataBook/create",data:{name:i.name.trim(),description:i.description.trim()||void 0},loader:!0,apiSuccessCallBack:x=>{r(x),m()}}))});return e.jsxs(a.Dialog,{open:o,handler:m,size:"xs",className:"relative overflow-hidden rounded-[32px] border border-white/30 bg-white/75 backdrop-blur-3xl shadow-[0_25px_80px_rgba(15,23,42,0.18)]",children:[e.jsx("div",{className:"pointer-events-none absolute -top-24 -left-24 h-56 w-56 rounded-full bg-blue-500/10 blur-3xl"}),e.jsx("div",{className:"pointer-events-none absolute -bottom-24 -right-24 h-56 w-56 rounded-full bg-cyan-400/10 blur-3xl"}),e.jsxs(a.DialogHeader,{className:"relative flex items-center gap-4 border-b border-white/30 px-6 py-5",children:[e.jsx("div",{className:"flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl",children:e.jsx("i",{className:`fa-solid ${d?"fa-pen":"fa-book"} text-xl text-white`})}),e.jsxs("div",{children:[e.jsx(a.Typography,{className:"text-lg font-bold text-gray-900",children:n(d?"khata.bookForm.edit.title":"khata.bookForm.create.title")}),e.jsx(a.Typography,{className:"mt-1 text-sm font-normal text-gray-900",children:n(d?"khata.bookForm.edit.subtitle":"khata.bookForm.create.subtitle")})]})]}),e.jsx(a.DialogBody,{className:"relative px-6 py-6",children:e.jsx(E,{initialValues:{name:(t==null?void 0:t.name)||"",description:(t==null?void 0:t.description)||""},validationSchema:c,onSubmit:l,validateOnMount:!0,children:({handleChange:i,handleBlur:x,values:f,errors:h,touched:u,isValid:g,isSubmitting:b})=>e.jsxs(I,{className:"flex flex-col gap-5",children:[e.jsx(B,{name:"name",label:n("khata.bookForm.form.name.label"),value:f.name,onChange:i,onBlur:x,error:u.name&&h.name,touched:u.name,autoFocus:!0}),e.jsx(B,{name:"description",label:n("khata.bookForm.form.description.label"),value:f.description,onChange:i,onBlur:x,error:u.description&&h.description,touched:u.description,required:!1}),e.jsxs("div",{className:"flex gap-4 pt-2",children:[e.jsx(a.Button,{type:"button",onClick:m,className:`\r
                                flex-1\r
                                rounded-lg\r
                                border\r
                                border-white/40\r
