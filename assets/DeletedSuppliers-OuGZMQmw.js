var x=(s,n,i)=>new Promise((c,o)=>{var g=r=>{try{m(i.next(r))}catch(u){o(u)}},p=r=>{try{m(i.throw(r))}catch(u){o(u)}},m=r=>r.done?c(r.value):Promise.resolve(r.value).then(g,p);m((i=i.apply(s,n)).next())});import{j as e}from"./pdfVendor-DdAo4azW.js";import{a as l,f as A,d as P}from"./reactVendor-BrBFq9LG.js";import{u as R,a as $,A as b,r as d}from"./index-Dpjft3Rl.js";import{D as B}from"./DefaultDashboardNavbar-CwpDQP-1.js";import"./reduxVendor-C8DwjTzm.js";import"./uiVendor-jE8dGr1d.js";import"./PlatformClassProvider-Y1y7fj-y.js";const I=12,Q=()=>{const{t:s}=R(),{dispatch:n,appSelector:i}=$(),c=i(t=>t.app),{deletedSupplierList:o={}}=c,{deletedSuppliers:g=[]}=o,[p,m]=l.useState(""),[r,u]=l.useState(""),[j,U]=l.useState(1),[a,f]=l.useState({open:!1,type:null,supplier:null}),C=A(),y=l.useCallback(()=>x(null,null,function*(){n(yield b({apiUrl:"supplier/getListOfDeleteSuppliers",storeActionType:"FETCH_ALL_DELETED_SUPPLIER_LIST",storeKey:"deletedSupplierList"}))}),[n]),N=l.useMemo(()=>{let t=g;return r&&(t=t.filter(h=>{var S,w,T,k;return((S=h.name)==null?void 0:S.toLowerCase().includes(r))||((w=h.phone)==null?void 0:w.toLowerCase().includes(r))||((T=h.address)==null?void 0:T.toLowerCase().includes(r))||((k=h.cardNumber)==null?void 0:k.toString().includes(r))})),t},[g,r]),v=l.useMemo(()=>N.slice(0,j*I),[N,j]),D=t=>x(null,null,function*(){n(yield b({method:"POST",apiUrl:`supplier/restore/${t._id}`,loader:!0,apiSuccessCallBack:()=>{y()}}))}),E=t=>x(null,null,function*(){n(yield b({method:"DELETE",apiUrl:`supplier/${t._id}`,loader:!0,apiSuccessCallBack:()=>{y()}}))}),L=t=>{f({open:!0,type:"restore",supplier:t})},_=t=>{f({open:!0,type:"delete",supplier:t})};return l.useEffect(()=>{const t=setTimeout(()=>{u(p.trim().toLowerCase())},300);return()=>clearTimeout(t)},[p]),l.useEffect(()=>{y()},[]),e.jsxs(e.Fragment,{children:[e.jsx(B,{back:!0,onBack:()=>C("/manage")}),e.jsxs("div",{className:"bg-[#f3f4f6] px-2 py-4 h-safe overflow-y-auto",children:[e.jsx("div",{className:"mb-4 flex justify-center",children:e.jsxs("div",{className:"relative w-full max-w-md",children:[e.jsx("input",{type:"text",placeholder:s("manage.deletedSuppliers.searchPlaceholder"),value:p,onChange:t=>m(t.target.value),className:`\r
