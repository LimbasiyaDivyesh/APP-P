var je=Object.defineProperty,Ne=Object.defineProperties;var ve=Object.getOwnPropertyDescriptors;var ie=Object.getOwnPropertySymbols;var we=Object.prototype.hasOwnProperty,ke=Object.prototype.propertyIsEnumerable;var le=(u,n,i)=>n in u?je(u,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):u[n]=i,I=(u,n)=>{for(var i in n||(n={}))we.call(n,i)&&le(u,i,n[i]);if(ie)for(var i of ie(n))ke.call(n,i)&&le(u,i,n[i]);return u},C=(u,n)=>Ne(u,ve(n));var S=(u,n,i)=>new Promise((m,v)=>{var f=g=>{try{T(i.next(g))}catch(w){v(w)}},p=g=>{try{T(i.throw(g))}catch(w){v(w)}},T=g=>g.done?m(g.value):Promise.resolve(g.value).then(f,p);T((i=i.apply(u,n)).next())});import{j as e,I as ye}from"./uiVendor-DaDaSio4.js";import{e as ce,h as ue,k as Te,a as o,u as Ie}from"./reactVendor-B0twF-WR.js";import{u as ae,d as _e,a as b,A as B,b as Pe,h as Q,z as ne}from"./index-B05rfTNQ.js";import De from"./DefaultDashboardNavbar-BYgrhmn3.js";import{c as oe,D as Me,C as Ce,P as Ee}from"./DailySaleAdminCustomerDailyRegister-BaY2fenJ.js";import{F as Se,a as Le}from"./formik.esm-BZLmt0RL.js";import{c as de,b as $e,d as ee,e as Ue}from"./index.esm-C8D8gKMb.js";import{F as Ae}from"./TableCellsIcon-mjBUDMDD.js";import{F as Re,a as Ye}from"./SunIcon-eMNN_8Dh.js";import"./pdfVendor-7UfZ2Nig.js";import"./reduxVendor-C6TQBnD8.js";import"./CustomerMilkPreferencesForm-DQ88-JT0.js";import"./editorVendor-ChLDk3K4.js";const Be=de().shape({milkTypeEntries:$e().of(de().shape({selected:Ue(),morning:ee().min(0).nullable(),evening:ee().min(0).nullable(),pricePerUnit:ee().min(0).required("Price required")})).test("at-least-one-selected","Please select at least one product",u=>u==null?void 0:u.some(n=>n.selected))}),Fe=u=>{const n=[];return u.forEach(i=>{const m=Number(i.morning),v=Number(i.evening),f=m>0,p=v>0;f&&p?(n.push(C(I({},i),{originalHadBoth:!0,dailyMilkQuantityInLiters:v,timePreference:"evening"})),n.push(C(I({},i),{originalHadBoth:!0,dailyMilkQuantityInLiters:m,timePreference:"morning"}))):!f&&p?n.push(C(I({},i),{originalHadBoth:!1,dailyMilkQuantityInLiters:v,timePreference:"evening"})):f&&!p&&n.push(C(I({},i),{originalHadBoth:!1,dailyMilkQuantityInLiters:m,timePreference:"morning"}))}),n},He=u=>{const{_id:n,milkTypeEntries:i,handleSaveAndCloseProductPopup:m}=u,v=n||u.purchaseId,{dispatch:f}=ae(),{isLoading:p}=_e(),T=w=>S(null,[w],function*({milkTypeEntries:g}){f(yield B({method:"PUT",apiUrl:`party/${v}/milk-preferences`,data:{milkPreferences:Fe(g.filter(d=>d.selected)).map(d=>{const L=d.originalHadBoth;return I({milkTypeId:d.milkTypeId,dailyMilkQuantityInLiters:1,timePreference:d.timePreference,pricePerUnit:d.pricePerUnit},v&&!L&&{_id:d._id})})},loader:!0,apiSuccessCallBack:()=>{m()}}))});return e.jsx(Se,{initialValues:{milkTypeEntries:i},validationSchema:Be,enableReinitialize:!0,onSubmit:T,children:({values:g,handleChange:w,handleBlur:d,errors:L,touched:j})=>e.jsxs(Le,{className:"flex flex-col h-[70vh] mb-0",children:[e.jsx("div",{className:"flex-1 pr-1 overflow-hidden",children:e.jsx("div",{className:"w-full h-full overflow-auto custom-scroll hide-scrollbar rounded-lg border border-gray-200 shadow-[0_4px_20px_rgba(0,0,0,0.06)] backdrop-blur-xl bg-white/60",children:e.jsxs("table",{className:"w-full border-collapse",children:[e.jsx("thead",{className:"bg-gradient-to-r from-indigo-50 to-purple-50/60 shadow-sm",children:e.jsxs("tr",{children:[e.jsx("th",{className:"py-4 px-1 sticky left-0 bg-indigo-50/70 backdrop-blur-md"}),e.jsx("th",{className:"py-4 px-1 text-left text-gray-700 font-semibold",children:"Product"}),e.jsx("th",{className:"py-4 px-1 text-center text-gray-700 font-semibold",children:e.jsx(ye,{size:16,className:"mx-auto text-gray-900 font-extrabold"})})]})}),e.jsx("tbody",{children:((g==null?void 0:g.milkTypeEntries)||[]).map(($,A)=>{var D,R;return e.jsxs("tr",{className:`border-b border-gray-200\r
