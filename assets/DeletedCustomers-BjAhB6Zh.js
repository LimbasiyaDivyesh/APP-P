var p=(s,l,d)=>new Promise((c,a)=>{var g=r=>{try{u(d.next(r))}catch(x){a(x)}},m=r=>{try{u(d.throw(r))}catch(x){a(x)}},u=r=>r.done?c(r.value):Promise.resolve(r.value).then(g,m);u((d=d.apply(s,l)).next())});import{j as e}from"./pdfVendor-DdAo4azW.js";import{a as n,f as R,d as A}from"./reactVendor-BrBFq9LG.js";import{u as P,a as $,A as b,r as i}from"./index-Dpjft3Rl.js";import{D as B}from"./DefaultDashboardNavbar-CwpDQP-1.js";import{F as M}from"./UserIcon-DES20Eof.js";import"./reduxVendor-C8DwjTzm.js";import"./uiVendor-jE8dGr1d.js";import"./PlatformClassProvider-Y1y7fj-y.js";const z=12,W=()=>{const{t:s}=P(),{dispatch:l,appSelector:d}=$(),c=d(t=>t.app),{deletedCustomerList:a={}}=c,{deletedCustomers:g=[]}=a,[m,u]=n.useState(""),[r,x]=n.useState(""),[j,O]=n.useState(1),[o,f]=n.useState({open:!1,type:null,customer:null}),k=R(),y=n.useCallback(()=>p(null,null,function*(){l(yield b({method:"POST",apiUrl:"customer/getListOfDeleteCustomers",storeActionType:"FETCH_ALL_DELETED_CUSTOMER_LIST",storeKey:"deletedCustomerList"}))}),[l]),N=n.useMemo(()=>{let t=g;return r&&(t=t.filter(h=>{var w,C,T,S;return((w=h.name)==null?void 0:w.toLowerCase().includes(r))||((C=h.phone)==null?void 0:C.toLowerCase().includes(r))||((T=h.address)==null?void 0:T.toLowerCase().includes(r))||((S=h.cardNumber)==null?void 0:S.toString().includes(r))})),t},[g,r]),v=n.useMemo(()=>N.slice(0,j*z),[N,j]),D=t=>p(null,null,function*(){l(yield b({method:"POST",apiUrl:`customer/restore/${t._id}`,loader:!0,apiSuccessCallBack:()=>{y()}}))}),E=t=>p(null,null,function*(){l(yield b({method:"DELETE",apiUrl:`customer/${t._id}`,loader:!0,apiSuccessCallBack:()=>{y()}}))}),L=t=>{f({open:!0,type:"restore",customer:t})},_=t=>{f({open:!0,type:"delete",customer:t})};return n.useEffect(()=>{const t=setTimeout(()=>{x(m.trim().toLowerCase())},300);return()=>clearTimeout(t)},[m]),n.useEffect(()=>{y()},[]),e.jsxs(e.Fragment,{children:[e.jsx(B,{back:!0,onBack:()=>k("/manage")}),e.jsxs("div",{className:"bg-[#f3f4f6] px-2 py-4 h-safe overflow-y-auto",children:[e.jsx("div",{className:"mb-4 flex justify-center",children:e.jsxs("div",{className:"relative w-full max-w-md",children:[e.jsx("input",{type:"text",placeholder:s("manage.deletedCustomers.searchPlaceholder"),value:m,onChange:t=>u(t.target.value),className:`\r
        ...
        `,children:[e.jsx("div",{className:"absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-500 bg-gradient-to-br from-blue-100/40 to-purple-100/40"}),e.jsxs("div",{className:"flex items-start gap-3 relative z-10",children:[e.jsxs("div",{className:"relative",children:[e.jsx("div",{className:"w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-md",children:e.jsx(M,{className:"w-6 h-6"})}),e.jsx("span",{className:"absolute -top-2 -left-2 px-1.5 py-[2px] text-[10px] rounded-full bg-black text-white shadow",children:a.cardNumber})]}),e.jsxs("div",{className:"min-w-0",children:[e.jsx(i.Typography,{className:"font-semibold text-[15px] text-gray-900 truncate",children:a.name}),e.jsx(i.Typography,{className:"text-[12px] text-gray-900",children:a.phone}),e.jsx(i.Typography,{className:"text-[12px] text-gray-900 truncate max-w-[180px]",children:a.address})]})]}),e.jsxs("div",{className:"flex justify-end gap-2 mt-4 relative z-10",children:[e.jsxs("button",{onClick:()=>l(s),className:`\r
                    ...
                    transition-all\r
                `,children:[e.jsx("i",{className:"fa-solid fa-rotate-left text-[10px]"}),c("manage.deletedCustomers.restoreButton")]}),e.jsxs("button",{onClick:()=>d(s),className:`\r
                    flex items-center gap-1\r
                    px-3 py-1.5 text-xs font-medium\r
                    rounded-lg\r
