var N=(o,m,t)=>new Promise((r,p)=>{var n=l=>{try{c(t.next(l))}catch(i){p(i)}},d=l=>{try{c(t.throw(l))}catch(i){p(i)}},c=l=>l.done?r(l.value):Promise.resolve(l.value).then(n,d);c((t=t.apply(o,m)).next())});import{j as e}from"./pdfVendor-BbcmCwHY.js";import{f as D,a as y}from"./reactVendor-BtoZ1Mrp.js";import{c as S,a as F,F as $,b as E}from"./index.esm-DXJrkG9j.js";import{a as T,u as C,A as w,r as a}from"./index-BtS0Bhih.js";import I from"./DefaultDashboardNavbar-DbdpovGE.js";import{F as P}from"./FloatingActionButton-BQpEWI9u.js";import{F as B}from"./FormInput-RPGromvR.js";import{F as M}from"./EllipsisVerticalIcon-CPwUE8mE.js";import{F as R,a as O}from"./TrashIcon-BGPGb6Yj.js";import"./reduxVendor--FhXtTDf.js";import"./uiVendor-C4Svfq-D.js";import"./PlatformClassProvider-DAr6yWLR.js";const v=(o=0)=>new Intl.NumberFormat("en-IN").format(o),z=({open:o,onClose:m,book:t,onSaved:r})=>{const{dispatch:p}=T(),{t:n}=C(),d=!!(t!=null&&t._id),c=S().shape({name:F().trim().required(n("khata.bookForm.validation.nameRequired")),description:F()}),l=i=>N(null,null,function*(){yield p(yield w({method:d?"PUT":"POST",apiUrl:d?`khataBook/${t._id}`:"khataBook/create",data:{name:i.name.trim(),description:i.description.trim()||void 0},loader:!0,apiSuccessCallBack:x=>{r(x),m()}}))});return e.jsxs(a.Dialog,{open:o,handler:m,size:"xs",className:"relative overflow-hidden rounded-[32px] border border-white/30 bg-white/75 backdrop-blur-3xl shadow-[0_25px_80px_rgba(15,23,42,0.18)]",children:[e.jsx("div",{className:"pointer-events-none absolute -top-24 -left-24 h-56 w-56 rounded-full bg-blue-500/10 blur-3xl"}),e.jsx("div",{className:"pointer-events-none absolute -bottom-24 -right-24 h-56 w-56 rounded-full bg-cyan-400/10 blur-3xl"}),e.jsxs(a.DialogHeader,{className:"relative flex items-center gap-4 border-b border-white/30 px-6 py-5",children:[e.jsx("div",{className:"flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl",children:e.jsx("i",{className:`fa-solid ${d?"fa-pen":"fa-book"} text-xl text-white`})}),e.jsxs("div",{children:[e.jsx(a.Typography,{className:"text-lg font-bold text-gray-900",children:n(d?"khata.bookForm.edit.title":"khata.bookForm.create.title")}),e.jsx(a.Typography,{className:"mt-1 text-sm font-normal text-gray-900",children:n(d?"khata.bookForm.edit.subtitle":"khata.bookForm.create.subtitle")})]})]}),e.jsx(a.DialogBody,{className:"relative px-6 py-6",children:e.jsx($,{initialValues:{name:(t==null?void 0:t.name)||"",description:(t==null?void 0:t.description)||""},validationSchema:c,onSubmit:l,validateOnMount:!0,children:({handleChange:i,handleBlur:x,values:f,errors:h,touched:u,isValid:g,isSubmitting:b})=>e.jsxs(E,{className:"flex flex-col gap-5",children:[e.jsx(B,{name:"name",label:n("khata.bookForm.form.name.label"),value:f.name,onChange:i,onBlur:x,error:u.name&&h.name,touched:u.name,autoFocus:!0}),e.jsx(B,{name:"description",label:n("khata.bookForm.form.description.label"),value:f.description,onChange:i,onBlur:x,error:u.description&&h.description,touched:u.description,required:!1}),e.jsxs("div",{className:"flex gap-4 pt-2",children:[e.jsx(a.Button,{type:"button",onClick:m,className:`\r
                                flex-1\r
                                rounded-lg\r
                                border\r
                                border-white/40\r
                            ...
                            `,children:e.jsx("div",{className:"flex items-center justify-center gap-2",children:b?e.jsxs(e.Fragment,{children:[e.jsx("i",{className:"fa-solid fa-spinner animate-spin"}),n("khata.bookForm.saving")]}):e.jsx(e.Fragment,{children:n(d?"khata.bookForm.update":"khata.bookForm.create.action")})})})]})]})},`${(t==null?void 0:t._id)||"new"}-${o}`)})]})},ee=()=>{const{dispatch:o,appSelector:m}=T(),t=D(),{t:r}=C(),[p,n]=y.useState(!1),[d,c]=y.useState(null),[l,i]=y.useState(null),{khataBookList:x={}}=m(s=>s.app),f=(x==null?void 0:x.data)||[],h=y.useCallback(()=>N(null,null,function*(){yield o(yield w({method:"GET",apiUrl:"khataBook",loader:!0,storeActionType:"FETCH_BOOK_LIST",storeKey:"khataBookList"}))}),[o]);y.useEffect(()=>{h()},[h]);const u=s=>N(null,null,function*(){yield o(yield w({method:"DELETE",apiUrl:`khataBook/${s._id}`,loader:!0,apiSuccessCallBack:()=>{h(),i(null)}}))}),g=()=>{c(null),n(!0)},b=s=>{c(s),n(!0)},_=s=>{h()};return e.jsxs("div",{className:"",children:[e.jsx(I,{headerTitle:r("khata.list.headerTitle"),back:!0,onBack:()=>t("/dashboard")}),e.jsx(P,{onClick:g}),e.jsx("div",{className:"relative bg-[#f3f4f6] px-2 py-4 h-safe overflow-y-auto",children:f.length===0?e.jsxs("div",{className:"flex flex-col items-center justify-center py-20 gap-4",children:[e.jsx("div",{className:"w-20 h-20 rounded-2xl bg-blue-50 flex items-center justify-center",children:e.jsx("i",{className:"fa-solid fa-book-open text-blue-400 text-3xl"})}),e.jsxs("div",{className:"text-center",children:[e.jsx(a.Typography,{className:"text-gray-900 font-semibold text-[15px]",children:r("khata.list.emptyTitle")}),e.jsx(a.Typography,{className:"text-gray-900 text-[13px] mt-1",children:r("khata.list.emptyDesc")})]}),e.jsxs(a.Button,{onClick:g,className:"rounded-xl bg-blue-600 normal-case px-6 shadow-md",children:[e.jsx("i",{className:"fa-solid fa-plus mr-2"})," ",r("khata.list.createBook")]})]}):e.jsx("div",{className:"flex flex-col gap-3",children:f.map((s,A)=>{const k=s.balance>=0;return e.jsxs("div",{className:"bg-white rounded-2xl border border-gray-200 shadow-md overflow-hidden active:scale-[0.98] transition-transform cursor-pointer",onClick:()=>t(`/khata/${s._id}`,{state:{bookName:s.name}}),children:[e.jsxs("div",{className:"flex items-start gap-3 p-4",children:[e.jsx("div",{className:"w-11 h-11 rounded-xl bg-blue-50 flex items-center justify-center flex-shrink-0",children:e.jsx("i",{className:"fa-solid fa-book text-blue-600 text-[17px]"})}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-start justify-between gap-3",children:[e.jsxs("div",{className:"min-w-0 flex-1",children:[e.jsx(a.Typography,{className:"truncate text-[16px] font-extrabold tracking-tight text-slate-800",children:s.name}),s.description?e.jsx(a.Typography,{className:"mt-1 line-clamp-2 text-[12px] leading-5 text-slate-500",children:s.description}):e.jsx(a.Typography,{className:"mt-1 text-[12px] italic text-slate-400",children:r("khata.list.noDescription")})]}),e.jsxs(a.Menu,{placement:"bottom-end",children:[e.jsx(a.MenuHandler,{children:e.jsx(a.IconButton,{variant:"text",size:"sm",onClick:j=>j.stopPropagation(),className:`\r
                    group\r
                    h-14\r
                    w-14\r
                    rounded-lg\r
